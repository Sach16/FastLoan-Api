...
@section('main')
    <h1>Bulk upload projects</h1>
    @include('admin.v1.layouts.partials._messages')
    <hr>
    <div class="well">
        <p>Download the template file below and fill upto 100 projects. Once done, upload using the form below.</p>
        <ul>
            <li>Maximum 100 records</li>
            <li>Maximum file size of 2MB</li>
            <li>All fields are mandatory</li>
            <li>Ensure there are no empty rows in the file</li>
            <li>Ensure Possession Date format as 'DD-MM-YYYY'</li>
        </ul>
        <a href="{{ route('admin.v1.projects.bulk.template') }}"
           class="btn btn small btn-primary">
            Download Template
        </a>
    </div>
    <form action="{{ route('admin.v1.projects.bulk.store') }}"
