...
@section('main')
    ...
    <hr>
    <form action="{{ route('admin.v1.referrals.update', $referral->id) }}" class="form-horizontal"
        ...
        <div class="form-group col-md-8 {{ hasErrors('first_name', $errors) }}">
            ...
            <input type="text" class="form-control" id="inputFirstName" name="first_name" value="{{ $referral->first_name }}">
        </div>

        {{--Last Name--}}
        <div class="form-group col-md-8 {{ hasErrors('last_name', $errors) }}">
            <label class="control-label" for="inputLastName">Last Name</label>
            <input type="text" class="form-control" id="inputLastName" name="last_name" value="{{ $referral->last_name }}">
        </div>

        {{--Email--}}
        <div class="form-group col-md-8 {{ hasErrors('email', $errors) }}">
            <label class="control-label" for="inputEmail">Email ID</label>
            <input type="text" class="form-control" name="email" id="inputEmail" value="{{ $referral->email }}" readonly>
        </div>

        {{--Phone--}}
        <div class="form-group col-md-8 {{ hasErrors('phone', $errors) }}">
            <label class="control-label" for="inputPhone">Phone Number</label>
            <input type="text" class="form-control" name="phone" id="inputPhone" value="{{ $referral->phone }}" readonly>
        </div>
        ...
        <div class="form-group col-md-8 {{ hasErrors('phone', $errors) }}">
            ...
            <select name="designation_id" id="inputDesignation" class="form-control" data-chosen>
                ...
                @foreach($designations as $designation)
                    <option value="{{ $designation->id }}" {{ isMatching($designation->id, $referral->designation->id) }}>
                        {{ $designation->name }}
                    </option>
                @endforeach
            </select>
        ...
        <div class="form-group col-md-8 {{ hasErrors('settings.dob', $errors) }}">
            ...
            <input type="text" class="form-control" data-dob-date
                   id="inputDateOfBirth" name="settings[dob]" value="{{ date('d-m-Y',strtotime($referral->settings['dob'])) }}">
        </div>
        ...
        <div class="form-group col-md-10 {{ hasErrors('alphaStreet', $errors) }}">
            ...
            <input type="text" class="form-control" id="inputAlphaStreet" name="alphaStreet"
                   value="{{ $referral->addresses()->first()->alpha_street }}">
        </div>
        ...
        <div class="form-group col-md-10 {{ hasErrors('betaStreet', $errors) }}">
            ...
            <input type="text" class="form-control" id="inputBetaStreet" name="betaStreet"
                   value="{{ $referral->addresses()->first()->beta_street }}">
        </div>

        {{--City--}}
        <div class="form-group col-md-8 {{ hasErrors('city', $errors) }}">
            <label class="control-label" for="inputCity">City</label>
            <input type="hidden" value="{{ ($referral->addresses->count() > 0 ) ? $referral->addresses->first()->city->id : "" }}" id="selected-city">
        ...
        <div class="form-group col-md-8 {{ hasErrors('state', $errors) }}">
            ...
            <input type="text" class="form-control" id="inputState" name="state"
                   value="{{ $referral->addresses()->first()->state }}">
        </div>
        ...
        <div class="form-group col-md-8 {{ hasErrors('country', $errors) }}">
            ...
            <input type="text" class="form-control" id="inputCountry" name="country"
                   value="{{ $referral->addresses()->first()->country }}">
        </div>
        ...
        <div class="form-group col-md-6 {{ hasErrors('zip', $errors) }}">
            ...
            <input type="text" class="form-control" id="inputZipCode" name="zipcode"
                   value="{{ $referral->addresses()->first()->zip }}">
        </div>
        ...
        <div class="form-group col-md-8 {{ hasErrors('settings.company', $errors) }}">
            ...
            <input type="text" class="form-control"
                   ...
                   value="{{ $referral->settings['company'] }}">
        </div>
        ...
        <div class="form-group col-md-8 {{ hasErrors('settings.facetime', $errors) }}">
            ...
            <input type="text" class="form-control"
                   ...
                   value="{{ $referral->settings['facetime'] }}">
        </div>
        ...
        <div class="form-group col-md-8 {{ hasErrors('settings.education', $errors) }}">
            ...
            <input type="text" class="form-control"
                   ...
                   value="{{ $referral->settings['education'] }}">
        </div>
        ...
        <div class="form-group col-md-8 {{ hasErrors('settings.net_income', $errors) }}">
            ...
            <input type="text" class="form-control"
                   ...
                   value="{{ $referral->settings['net_income'] }}">
        </div>
        ...
        <div class="form-group col-md-8 {{ hasErrors('settings.profession', $errors) }}">
            ...
            <select name="settings[profession]" id="inputProfession" class="form-control" data-chosen>
                ...
                <option value="Salaried" {{ isMatching('Salaried', @$referral->settings['profession']) }}>
                    Salaried
                </option>
                <option value="Doctor" {{ isMatching('Doctor', @$referral->settings['profession']) }}>
                    Doctor
                </option>
                <option value="Self Employed-Professionals"
                        {{ isMatching('Self Employed-Professionals', @$referral->settings['profession']) }}>
                    Self employed professional
                </option>
                <option value="Self Employed-Others"
                        {{ isMatching('Self Employed-Others', @$referral->settings['profession']) }}>
        ...
        <div class="form-group col-md-8 {{ hasErrors('settings.cibil_score', $errors) }}">
            ...
            <input type="text" class="form-control"
                   ...
                   value="{{ @$referral->settings['cibil_score'] }}">
        </div>
        ...
        <div class="form-group col-md-8 {{ hasErrors('settings.cibil_status', $errors) }}">
            ...
            <select name="settings[cibil_status]" id="inputCibilStatus" class="form-control" data-chosen>
                ...
                <option value="Settled A/C" {{ isMatching('Settled A/C', @$referral->settings['cibil_status']) }}>Settled A/C</option>
                <option value="Written off A/C" {{ isMatching('Written off A/C', @$referral->settings['cibil_status']) }}>Written off A/C</option>
                <option value="Overdue A/C" {{ isMatching('Overdue A/C',@$referral->settings['cibil_status']) }}>Overdue A/C</option>
                <option value="Good A/C" {{ isMatching('Good A/C', @$referral->settings['cibil_status']) }}>Good A/C</option>
            </select>
        </div>
        ...
        <div class="form-group col-md-8 {{ hasErrors('settings.salary_bank', $errors) }}">
            ...
            <input type="text" class="form-control"
                   ...
                   value="{{ @$referral->settings['salary_bank'] }}">
        </div>
        ...
        <div class="form-group col-md-8 {{ hasErrors('settings.contact_time', $errors) }}">
            ...
            <input type="text" class="form-control"
                   ...
                   value="{{ @$referral->settings['contact_time'] }}" data-timeSelector>
        </div>
        ...
        <div class="form-group col-md-8 {{ hasErrors('settings.marital_status', $errors) }}">
            ...
            <select name="settings[marital_status]" id="inputMaritalStatus" class="form-control" data-chosen>
                ...
                <option value="Married" {{ isMatching('Married', @$referral->settings['marital_status']) }}>Married</option>
                <option value="Unmarried" {{ isMatching('Unmarried', @$referral->settings['marital_status']) }}>Unmarried</option>
            </select>
        </div>
        ...
        <div class="form-group col-md-8 {{ hasErrors('settings.resident_status', $errors) }}">
            ...
            <select name="settings[resident_status]" id="inputResidentStatus" class="form-control" data-chosen>
                ...
                <option value="Indian" {{ isMatching('Indian', @$referral->settings['resident_status']) }}>
                    Indian
                </option>
                <option value="PIO/OCI" {{ isMatching('PIO/OCI', @$referral->settings['resident_status']) }}>
                    PIO/OCI
                </option>
                <option value="NRI" {{ isMatching('NRI', @$referral->settings['resident_status']) }}>
                    NRI
                </option>
            </select>
        </div>
        ...
        <div class="form-group">
            <div class="col-lg-10 col-lg-offset-2">
                <a href="{{ route('admin.v1.referrals.show', $referral->id) }}" class="btn btn-default" >Back</a>
