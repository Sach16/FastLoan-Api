...
@section('main')
    ...
    <hr>
    <div class="well">
        <p>Download the template file below and fill upto 100 customers. Once done, upload using the form below.</p>
        <ul>
            <li>Maximum 100 records</li>
            <li>Maximum file size of 2MB</li>
            <li>All fields are mandatory</li>
            <li>Ensure there are no empty required fields rows in the file</li>
            <li>Ensure Date of Birth format as 'DD-MM-YYYY'</li>
        </ul>
        <a href="{{ route('admin.v1.customers.bulk.template') }}"
           class="btn btn small btn-primary">
            Download Template
        </a>
    </div>
    <form action="{{ route('admin.v1.customers.bulk.store') }}"
