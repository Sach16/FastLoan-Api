...
@section('main')
    ...
    <hr>
    <form action="{{ route('admin.v1.customers.store') }}" class="form-horizontal"
    enctype="multipart/form-data"  method="post">
        ...
        <div class="form-group col-md-8 {{ hasErrors('settings.resident_status', $errors) }}">
            ...
            <select name="settings[resident_status]" id="inputResidentStatus" class="form-control" data-chosen>
                ...
                <option value="Indian" {{ isMatching('Indian', old('settings.resident_status')) }}>
                    Indian
                </option>
        ...
        <div class="form-group col-md-8 {{ hasErrors('city_id', $errors) }}">
            ...
            <select name="city_id" id="inputAssignedTo" class="form-control" value="{{ old('city_id') }}" data-city></select>
        </div>
