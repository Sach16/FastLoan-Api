...
use Whatsloan\Http\Requests\Api\V1\BankProductRequest;
use Whatsloan\Http\Transformers\V1\ResourceCreated;
use Whatsloan\Http\Transformers\V1\ResourceUpdated;
use Whatsloan\Http\Transformers\V1\BanksProductsTransformer;
...
{    
     ...
     * @return type
     */
    public function bankProducts(BankProductRequest $request)
    {   
        $bankProducts = $this->banks->getBankProducts();
        return $this->transformCollection($bankProducts, TypeTransformer::class); 
    }  
}
