...
class BankTransformer extends TransformerAbstract
{
    ...
    {
        return $this->item($bank->pivot, new BanksProjectsPivotTransformer);
    }
    
    public function includeAttachments(Bank $bank)
    {
        return $this->collection($bank->attachments, new AttachmentTransformer);
    }
